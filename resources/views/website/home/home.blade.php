...
@section('content')
    <div class="carousel slide" data-bs-ride="carousel" data-bs-intervel="1000" id="heroSlider">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{asset('/')}}website/img/slider1.jpg" alt="" class="w-100 h-550">
                <div class="carousel-caption">
                    <h3>Web Development Master</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium adipisci animi consequuntur dolor doloribus error iste modi molestias optio possimus, quis ut vel voluptates! Aliquam cupiditate molestiae nesciunt repellat suscipit?</p>
